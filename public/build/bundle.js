...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 6, 4, 152);
    			add_location(button, file$4, 8, 4, 176);
    ...
    const file$3 = "src/darkmode.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			t = text(/*label*/ ctx[0]);
    			add_location(button, file$3, 32, 0, 731);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 6, 4, 186);
    			add_location(br, file$2, 7, 4, 234);
    			attr_dev(div, "class", "settings svelte-1k2h89l");
    			add_location(div, file$2, 5, 0, 140);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ slide, Darkmode, closeSettings });
    ...
    class Settings extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { closeSettings: 0 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 15, 4, 358);
    			add_location(button1, file$1, 16, 4, 416);
    			attr_dev(h3, "class", "timer svelte-1uxou2x");
    			add_location(h3, file$1, 17, 4, 475);
    			attr_dev(div, "class", "sidebar svelte-1uxou2x");
    			add_location(div, file$1, 13, 0, 315);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "--color", /*_row*/ ctx[19][/*column*/ ctx[24]]);
    			add_location(div, file, 134, 5, 4404);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block_4(ctx) {
    	let previous_key = /*game*/ ctx[0].guesses[/*row*/ ctx[21]].charAt(/*column*/ ctx[24]).toUpperCase();
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*game*/ 1 && safe_not_equal(previous_key, previous_key = /*game*/ ctx[0].guesses[/*row*/ ctx[21]].charAt(/*column*/ ctx[24]).toUpperCase())) {
    				group_outros();
    ...
    function create_key_block(ctx) {
    	let div;
    	let t0_value = /*game*/ ctx[0].guesses[/*row*/ ctx[21]][/*column*/ ctx[24]].toUpperCase() + "";
    	let t0;
    	let t1;
    	let div_transition;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "box svelte-g3b5so");
    			set_style(div, "--color", /*_row*/ ctx[19][/*column*/ ctx[24]]);
    			add_location(div, file, 125, 6, 4218);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*game*/ 1) && t0_value !== (t0_value = /*game*/ ctx[0].guesses[/*row*/ ctx[21]][/*column*/ ctx[24]].toUpperCase() + "")) set_data_dev(t0, t0_value);
    ...
    function create_each_block_1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*game*/ ctx[0].guesses[/*row*/ ctx[21]]) return 0;
    		return 1;
    	}
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 152, 3, 4771);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 150, 3, 4711);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    ...
    function create_if_block(ctx) {
    	...
    	settings = new Settings({
    			props: { closeSettings: /*func_1*/ ctx[17] },
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*settingsOpen*/ 256) settings_changes.closeSettings = /*func_1*/ ctx[17];
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input_1, file, 142, 2, 4535);
    			attr_dev(div1, "class", "input svelte-g3b5so");
    			add_location(div1, file, 141, 1, 4513);
    			add_location(main, file, 115, 0, 3932);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
