...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 6, 4, 158);
    			add_location(button, file$3, 8, 4, 184);
    			attr_dev(div, "class", "popup svelte-8vo8ko");
    			add_location(div, file$3, 5, 0, 116);
    		},
    ...
    class Popup extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { message: 0, onClose: 1 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			h3 = element("h3");
    			t3 = text(/*timeElapsed*/ ctx[0]);
    			add_location(button, file$1, 14, 4, 345);
    			attr_dev(h3, "class", "timer svelte-1uxou2x");
    			add_location(h3, file$1, 15, 4, 408);
    			attr_dev(div, "class", "sidebar svelte-1uxou2x");
    			add_location(div, file$1, 12, 0, 300);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*timeElapsed*/ 1) set_data_dev(t3, /*timeElapsed*/ ctx[0]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	setInterval(
    		() => {
    			...
    			$$invalidate(0, timeElapsed = new Date(Date.now() - game.started).toISOString().substr(11, 8));
    		},
    		1000
    	);
    	...
    	$$self.$capture_state = () => ({ Darkmode, game, timeElapsed });

    	$$self.$inject_state = $$props => {
    		if ('game' in $$props) $$invalidate(1, game = $$props.game);
    		if ('timeElapsed' in $$props) $$invalidate(0, timeElapsed = $$props.timeElapsed);
    	};
    	...
    	return [timeElapsed, game, click_handler];
    }

    class Sidebar extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { game: 1 });
    ...
    function create_else_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "--color", /*_row*/ ctx[16][/*column*/ ctx[21]]);
    			add_location(div, file, 134, 5, 4421);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block_3(ctx) {
    	let previous_key = /*game*/ ctx[0].guesses[/*row*/ ctx[18]].charAt(/*column*/ ctx[21]).toUpperCase();
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*game*/ 1 && safe_not_equal(previous_key, previous_key = /*game*/ ctx[0].guesses[/*row*/ ctx[18]].charAt(/*column*/ ctx[21]).toUpperCase())) {
    				group_outros();
    ...
    function create_key_block(ctx) {
    	let div;
    	let t0_value = /*game*/ ctx[0].guesses[/*row*/ ctx[18]][/*column*/ ctx[21]].toUpperCase() + "";
    	let t0;
    	let t1;
    	let div_transition;
    	let current;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "box svelte-g3b5so");
    			set_style(div, "--color", /*_row*/ ctx[16][/*column*/ ctx[21]]);
    			add_location(div, file, 125, 6, 4226);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if ((!current || dirty & /*game*/ 1) && t0_value !== (t0_value = /*game*/ ctx[0].guesses[/*row*/ ctx[18]][/*column*/ ctx[21]].toUpperCase() + "")) set_data_dev(t0, t0_value);
    ...
    function create_each_block_1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*game*/ ctx[0].guesses[/*row*/ ctx[18]]) return 0;
    		return 1;
    	}
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 152, 3, 4806);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 150, 3, 4744);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*processInput*/ ctx[8], false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*inputValid*/ ctx[5] === true) return create_if_block_2;
    		return create_else_block;
    	}

    	let current_block_type = select_block_type_1(ctx);
    	let if_block0 = current_block_type(ctx);
    	let if_block1 = /*won*/ ctx[2] && !/*closedWonPopup*/ ctx[6] && create_if_block_1(ctx);
    	let if_block2 = /*lose*/ ctx[3] && !/*closedLosePopup*/ ctx[7] && create_if_block(ctx);

    	sidebar = new Sidebar({
    			props: { game: /*game*/ ctx[0] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 117, 1, 3955);
    			...
    			add_location(input_1, file, 142, 2, 4560);
    			attr_dev(div1, "class", "input svelte-g3b5so");
    			add_location(div1, file, 141, 1, 4537);
    			add_location(main, file, 115, 0, 3930);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input_1, "keypress", /*onKeyPress*/ ctx[9], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('input' in $$props) $$invalidate(12, input = $$props.input);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*_input, input*/ 4098) {
    			{
    				$$invalidate(12, input = _input === null || _input === void 0
    				? void 0
    		...
    		if ($$self.$$.dirty & /*won, lose, game, input*/ 4109) {
